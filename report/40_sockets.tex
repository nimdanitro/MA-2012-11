...
the time of the day, the monitoring ratio of the bidirectional flows is mainly between 90\% and 97\%. There are always smaller monitoring ratios during night yielding that at night there is a higher share of unknown server sockets active than during day. A reason for this is that during night there are just not enough bidirectional flows to the same server socket during 600 seconds such that this socket is successfully detected as concentrator.
