...
\newglossaryentry{socket}{
	name={socket},
	description={A socket is uniquely defined by the triple (\textbf{IP address}, \textbf{IP protocol number} and \textbf{protocol port number}). In this context, a socket is only defined for IP protocol 6 (\gls{TCP}) and 17 (\gls{UDP}).}
	plural={sockets},
}
